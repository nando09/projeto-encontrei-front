	...
	export default {
		...
		methods: {
			updateUsuario() {
				...
				formData.append("razao_social", this.razao_social);
				formData.append("nome_fantasia", this.nome_fantasia);
				...
				formData.append("uteis_ini", this.uteis_ini);
				formData.append("uteis_fim", this.uteis_fim);
				formData.append("sabado_ini", this.sabado_ini);
				formData.append("sabado_fim", this.sabado_fim);
				formData.append("domingo_ini", this.domingo_ini);
				formData.append("domingo_fim", this.domingo_fim);
				formData.append("feriados_ini", this.feriados_ini);
				formData.append("feriados_fim", this.feriados_fim);
				...
				axios.post(
					"https://service.encontrei.online/api/prestador_update",
					formData,
					{
						headers: {
			...
			getUsuario(){
				...
				axios.get(
					...
					.then(response => {
						...
						this.uteis_ini						= response.uteis_ini.substring(0,5);
						this.uteis_fim						= response.uteis_fim.substring(0,5);
						this.sabado_ini						= response.sabado_ini.substring(0,5);
						this.sabado_fim						= response.sabado_fim.substring(0,5);
						this.domingo_ini					= response.domingo_ini.substring(0,5);
						this.domingo_fim					= response.domingo_fim.substring(0,5);
						this.feriados_ini					= response.feriados_ini.substring(0,5);
						this.feriados_fim					= response.feriados_fim.substring(0,5);
						this.photo = 'https://image.service.encontrei.online/' + response.photo;
						this.loadingPage = false;
					});
