...
<!--                    <br>-->
                    ...
                    <div class="col-12 p-0">
                      <label>E-mail</label>
                      <input class="form-control"  type="email" name="senderEmail" id="senderEmail" placeholder="E-mail do comprador" value="c64862093590784097173@sandbox.pagseguro.com.br" required>
                    </div>
                    <br>
                    ...
                    <button class="btn btn-primary" type="submit" name="btnComprar" id="btnComprar" value="Comprar">
                      Comprar
                    </button>
                  </form>
